...
- Never edit `docs/parameters_trex.rst` directly; it is regenerated automatically. Update parameter definitions and descriptions in `Application/src/tracker/core/default_config.cpp` instead.
