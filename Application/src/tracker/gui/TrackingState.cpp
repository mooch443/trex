    ...
    _controller(std::make_unique<VIControllerImpl>(video, *this))
{
    _end_task_check_auto_quit = [this, gui](){
            ...
            if(BOOL_SETTING(auto_categorize)) {
                ...
                if(BOOL_SETTING(auto_tags_on_startup))
