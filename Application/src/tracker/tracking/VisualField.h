...
namespace track {    
    ...
    public:
        ...
        static std::tuple<std::array<eye, 2>, Vec2> generate_eyes(const Individual::BasicStuff& basic, const std::vector<Vec2>& outline, const Midline::Ptr& midline, float angle);
    };
}
