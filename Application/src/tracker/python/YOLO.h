...
private:
    ...
    static void process_instance_segmentation(const track::detect::PredictionFilter& detect_only_classes, coord_t w, coord_t h, const cv::Mat& r3, SegmentationData&, track::detect::Result&, const AcceptanceSettings&, const std::vector<size_t>* filtered_indices = nullptr);
    static void process_boxes_only(const track::detect::PredictionFilter& detect_only_classes, coord_t w, coord_t h, const cv::Mat& r3, SegmentationData&, track::detect::Result&, const AcceptanceSettings&, const std::vector<size_t>* filtered_indices = nullptr);
    static void process_obbs(const track::detect::PredictionFilter& detect_only_classes, coord_t w, coord_t h, const cv::Mat& r3, SegmentationData&, track::detect::Result&, const AcceptanceSettings&, const std::vector<size_t>* filtered_indices = nullptr);
    static void process_points(const track::detect::PredictionFilter& detect_only_classes, coord_t w, coord_t h, const cv::Mat& r3, SegmentationData&, track::detect::Result&, const AcceptanceSettings&, const std::vector<size_t>* filtered_indices = nullptr);
