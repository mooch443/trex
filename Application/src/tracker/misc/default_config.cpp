...
//#endif
        ...
        CONFIG("segment_size_filter", SizeFilters(), "During conversion (using background subtraction) objects outside this size range will be filtered out. If empty, all objects will be accepted.");
