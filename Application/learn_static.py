...
def load_weights():
    ...
    try:
        ...
        TRex.warn(str(e))
        raise Exception("Failed to load weights. This is likely because either the recognition_image_size is different, or because existing weights might have been generated by a different version of TRex (see visual_identification_version).")
